...
use App\Repository\SalaryLevelRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: SalaryLevelRepository::class)]
class SalaryLevel
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: PersonOffer::class, mappedBy: 'salaryLevel')]
    ...
    public function addPersonOffer(PersonOffer $personOffer): static
    {
        if (!$this->personOffers->contains($personOffer)) {
            ...
            $personOffer->setSalaryLevel($this);
        }
    ...
    public function removePersonOffer(PersonOffer $personOffer): static
    {
        if ($this->personOffers->removeElement($personOffer)) {
            ...
            if ($personOffer->getSalaryLevel() === $this) {
                $personOffer->setSalaryLevel(null);
            }
        }
